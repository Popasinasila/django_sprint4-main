...
class EntryDetailView(SingleObjectMixin, ListView):
    """
    Отдельный пост.
...
class CategoryFeedView(SingleObjectMixin, ListView):
    """Категория постов."""
...
class UserFeedView(SingleObjectMixin, ListView):
...
class EntryUpdateView(OnlyAuthorMixin, UpdateView):
...
class EntryDeleteView(OnlyAuthorMixin, DeleteView):
    """Удаление поста."""
...
class FeedbackUpdateView(OnlyAuthorMixin, UpdateView):
...
class FeedbackDeleteView(OnlyAuthorMixin, DeleteView):
